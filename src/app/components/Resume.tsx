import { Phone, Mail, MapPin, Award, Briefcase, GraduationCap, Settings, Shield, CheckCircle2, FileCheck } from 'lucide-react';
    ...
    <div className="min-h-screen py-8 px-4" style={{ backgroundColor: '#F9FAFB' }}>
      <div className="max-w-[210mm] mx-auto space-y-6">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={index} className="text-[10px] flex items-start gap-2" style={{ color: '#111827' }}>
                      <span className="font-bold" style={{ color: '#2CA6A4' }}>•</span>
                      <span>{cert}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-white rounded-lg border shadow-sm relative overflow-hidden" style={{ borderColor: '#E5E7EB' }}>
                ...
                <div className="p-4 pl-5">
                  ...
                  <p className="text-[11px] leading-relaxed" style={{ color: '#111827' }}>
                    Results-driven Facilities Management Engineer with <strong>7+ years</strong> of comprehensive experience in facility operations, maintenance, and safety compliance. Proven track record of managing large-scale commercial facilities in <strong>Singapore</strong>, including Shell Marketing Centre and One Raffles Place. Expertise in HVAC systems, fire protection, preventive maintenance programs, and vendor coordination. Strong focus on workplace safety (WSH), operational efficiency, and team leadership while ensuring compliance with international standards.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <div className="flex-1">
                    <h3 className="text-[12px] font-bold" style={{ color: '#2CA6A4' }}>
                      E-Tech Building Services Pte Ltd – Singapore
                    </h3>
                    <p className="text-[11px] font-semibold" style={{ color: '#1F3A5F' }}>
                      Senior Facilities Engineer | Shell Marketing Centre
                    </p>
                    <p className="text-[9px]" style={{ color: '#6B7280' }}>
        ...
        <div className="bg-white shadow-md p-8" style={{ width: '210mm', minHeight: '297mm' }}>
          ...
          {/* KEY RESPONSIBILITIES - MINI CARDS */}
